        ...
        <div class="card-body">
            ...
            <form action="Controlador?menu=Cliente" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" value="${clienteEncontrado.getNombreCliente()}" name="txtNombreCliente" class="form-control">
                </div>
                <div class="form-group">
                    <%--Cambian el atributo: de la etiqueta <Label> y colocan sus atributos--%>
                    <label>Apellido Cliente:</label>
                    <input type="text" value="${clienteEncontrado.getApellidoCliente()}" name="txtApellidoCliente" class="form-control">
                </div>
                <div class="form-group">
                    <label>Teléfono Cliente:</label>
                    <input type="number" value="${clienteEncontrado.getTelefonoCliente()}" name="txtTelefonoCliente" class="form-control">
                </div>
                <div class="form-group">
                    <label>Direccion Cliente:</label>
                    <input type="text" value="${clienteEncontrado.getDireccionCliente()}" name="txtDireccionCliente" class="form-control">
                </div>
                <div class="form-group">
                    <%--Cambian el atributo: de la etiqueta <Label> y colocan sus atributos--%>
                ...
                <div class="form-group">
                    ...
                    <select name="txtIdAfiliado">
                        <c:forEach var="afiliado" items="${afiliados}">
                            <option name="txtIdAfiliado" value="${afiliado.getIdAfiliado()}">${afiliado.getIdAfiliado()}</option>
